...
with torch.no_grad():
    ...
    for img_num in range(100):
        x_gen, x_gen_store = ddpm.sample(10, (3, 28, 28), device, guide_w=2.0)
        for class_idx in range(n_classes):
            save_image(x_gen[class_idx], os.path.join(output_dir, f"{class_idx}_" +"{0:03}".format(img_num+1)+ ".png"))
